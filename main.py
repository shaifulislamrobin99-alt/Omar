...
class Game:
    ...
    def load_background_music(self):
        """Load the Undyne background music"""
        music_file = "Undertale Undyne the Undying [TubeRipper.com].wav"
        try:
    ...
    def draw_menu(self):
        ...
        # Show music status
        music_status = "♪ Music: ON" if self.music_loaded else "♪ Music: NOT LOADED"
